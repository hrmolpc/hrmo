...
<div class="card">
  ...
  <div class="table-responsive text-nowrap">
    <table class="table">
      <thead>
        <tr>
          <th class="col-1">{{ __('Employee Number') }}</th>
          <th class="col-5">{{ __('Account Type') }}</th>
    ...
    <tr>
        ...
        <td>
            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                <a href="{{ route('structure-employees-info', $employee->employee_id) }}">
                    {{ ucfirst($employee->account_type) }}
                </a>
            </ul>
        </td>
